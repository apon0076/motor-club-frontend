  ...
  return (
    <div className="invoicePrint">
        ...
        <div className="w-4/12 ml-2">
          ...
          <table className="invoice__table mt-3">
            ...
            <tr>
              ...
              <td className="pl-5 align-top">{invoice?.customerInfo?.phone}</td>
            </tr>
            <tr>
            ...
            <tr>
              <th className="align-top invoice__table--td">
                Service Technician:
              </th>
              <td className="pl-5 align-top">
        ...
        <div className="w-5/12 ml-2">
          <table className=" invoice__table  mt-3">
            ...
            <tr>
              ...
              <td className="pl-5 align-top">{invoice?.invoice?.date_in}</td>
            </tr>
            <tr>
              <th className="align-top">Date Out:</th>
              <td className="pl-5 align-top">{invoice?.invoice?.date_out}</td>
            </tr>
            <tr>
      ...
      <div className="flex justify-end mt-2">
        <table className="invoice__table  invoice__summary__table">
          ...
          <tr>
            ...
            <td>{invoice?.invoice?.advance_payment}</td>
          </tr>
          <tr>
            <td>To Pay</td>
            <td>
              {invoice?.invoice?.final_price -
                invoice?.invoice?.advance_payment}
            </td>
          </tr>
        </table>
      </div>
      ...
      <div className="flex justify-end mt-5">
        <button
          className="print-btn rounded  flex items-center text-white font-semibold px-4 py-2 bg-red-800 transition-all ease-in-out hover:bg-red-900 cursor-pointer"
          onClick={() => {
            window.print();
          }}
        >
