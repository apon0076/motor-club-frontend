...
export default function SidebarToggle({setSidebarToggle, sidebarToggle}) {
    ...
    return (
        <div className="absolute sidebarToggleSection w-4/12 bg-white h-screen">
            <div className="flex justify-end">
                <FaBars className="menuToggle__icon m-2" size="1.8rem"
